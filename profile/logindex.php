...
<head>
    ...
    <title>Login to Pawfect Match</title>
</head>
<body>
<header>
        <a href="#" class="logo">
...
<br><br><br>
<div class="container">
    <form class="form" action="../login/authenticate.php" method="POST">
        <p id="heading">Login</p>
            ...
            <div class="btn">
                ...
                <button class="button2" onclick="redirectToSignUp()" type="button">Sign Up</button>
            </div>
